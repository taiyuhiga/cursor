...
export const FileIcons = {
  ...
  File: ({ className }: IconProps) => (
    <svg viewBox="0 0 16 16" className={`${className} text-zinc-400`} fill="currentColor">
  ...
  Plain: ({ className }: IconProps) => (
    <svg viewBox="0 0 16 16" className={`${className} text-zinc-400`} fill="none" stroke="currentColor" strokeWidth="1.2" strokeLinecap="round" strokeLinejoin="round">
